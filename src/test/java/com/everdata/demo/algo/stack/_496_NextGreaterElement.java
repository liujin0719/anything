...
public class _496_NextGreaterElement {
    public static void main(String[] args) {
        _496_NextGreaterElement nextGreaterElement = new _496_NextGreaterElement();
        ...
        System.out.println(Arrays.toString(nextGreaterElement.nextGreaterElement2(new int[]{4, 1, 2}, new int[]{1, 3, 4, 2})));
        System.out.println(Arrays.toString(nextGreaterElement.nextGreaterElement2(new int[]{2, 4}, new int[]{1, 2, 3, 4})));
    }
    ...
    public int[] nextGreaterElement2(int[] nums1, int[] nums2) {
        ...
        int[] greater = nextGreaterElement2(nums2);
